...
export function AccountPage({
  ...
  async function downloadInvitePoster(): Promise<void> {
    ...
    try {
      ...
      context.fillRect(72, 852, 936, 474);
      context.fillStyle = "#0f766e";
      context.font = "900 28px sans-serif";
      context.fillText("商图 AI 助手", 110, 928);
      context.fillStyle = "#0f172a";
      context.font = "900 48px sans-serif";
      context.fillText("一张商品图，生成电商场景素材", 110, 990);
      context.font = "700 27px sans-serif";
      context.fillStyle = "#334155";
      context.fillText("主图优化 / 模特场景图 / 详情页素材", 110, 1050);
      context.fillText("跨境平台图片重做，文字翻译去水印", 110, 1094);
      context.fillStyle = "#0f766e";
      context.font = "900 28px sans-serif";
      context.fillText(`注册额外送 ${formatCreditReward(inviteeRegisterCredits)}`, 110, 1154);
      context.fillStyle = "#334155";
      context.font = "700 25px sans-serif";
      context.fillText(`邀请码：${referral.inviteCode}`, 110, 1202);
      const qr = await loadImage(inviteQrDataUrl);
      context.drawImage(qr, 794, 922, 196, 196);
      context.fillStyle = "#0f766e";
      context.font = "900 28px sans-serif";
      context.fillText("扫码免费试用", 810, 1160);
      context.fillStyle = "#475569";
      context.font = "600 24px sans-serif";
      context.fillText(inviteUrl.replace(/^https?:\/\//u, ""), 110, 1270);
