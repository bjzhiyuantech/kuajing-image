const SCENES = [
  ...
  { id: "single-product-long-poster", label: "单品长海报" },
  ...
  { id: "category-kit-auto-main", label: "平台主图" },
  { id: "category-kit-auto-hero", label: "点击主图" },
  { id: "category-kit-auto-overview", label: "整体展示" },
  { id: "category-kit-auto-benefits", label: "核心卖点" },
  { id: "category-kit-auto-detail", label: "细节材质" },
  { id: "category-kit-auto-structure", label: "结构工艺" },
  { id: "category-kit-auto-guide", label: "规格尺寸" },
  { id: "category-kit-auto-package", label: "包装清单" },
  { id: "category-kit-auto-usage", label: "用法步骤" },
  { id: "category-kit-auto-lifestyle", label: "场景转化" },
  { id: "category-kit-auto-audience", label: "人群场景" },
  { id: "category-kit-auto-trust", label: "保障注意" },
